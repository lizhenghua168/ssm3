package com.worlk.common.pagination;
...
import com.worlk.common.pagination.domain.Paginator;
import com.worlk.common.pagination.support.PropertiesHelper;
import com.worlk.common.pagination.support.SQLHelp;
	...
	public Object intercept(final Invocation invocation) throws Throwable {
        ...
        if(dialect.supportsLimit() && (offset != RowBounds.NO_ROW_OFFSET || limit != RowBounds.NO_ROW_LIMIT)) {
            ...
            if (dialect.supportsLimitOffset()) {
                ...
                sql = dialect.getPageSql(sql, 0, limit);
            }
