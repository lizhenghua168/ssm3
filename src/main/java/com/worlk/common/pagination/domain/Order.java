package com.worlk.common.pagination.domain;
...
public class Order implements Serializable {
    ...
    /**
     * PropertyPath implements the pairing of an {@link com.worlk.common.pagination.domain.Order.Direction} and a property. It is used to provide input for
     *
